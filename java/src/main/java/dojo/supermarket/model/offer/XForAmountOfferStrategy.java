...
public class XForAmountOfferStrategy extends OneProductOffer {
    private final int requiredQuantity;

    public XForAmountOfferStrategy(Date startDate, Date endDate, double argument, Product product, int requiredQuantity) {
        super(startDate, endDate, argument, product);
        this.requiredQuantity = requiredQuantity;
    }

    public XForAmountOfferStrategy(double argument, Product product, int requiredQuantity) {
